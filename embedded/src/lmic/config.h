...
// New configuration
// To send more frequently messages, disable the RX windows 1 and 2
#define Disable_RX_WIN
...
// Define the regional parameters
//#define CFG_eu868 1
//#define CFG_us915 1
#define CFG_au915 1

// The AU 915 is a adaptation of US915 in this firmware, so if AU915
// is chosen, must define US915 too.
